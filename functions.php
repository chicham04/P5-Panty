...
function add_admin_link($items, $args)
{
    if (is_user_logged_in()) {
        ...
        $bouton = '<li id="menu-principal" class="admin menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-11 current_page_item menu-principal" ><a class="menu-link" href="' . get_admin_url() . '">Admin</a></li>';
